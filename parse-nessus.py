...
csvHeaders = ['Severity', 'IP Address', 'Port', 'Vulnerability', 'CVE']
nessusFields = ['risk_factor', 'host-ip', 'port', 'plugin_name', 'cve']
reportRows = []
findings = []
...
def process_nessus_files():
    ...
    return sorted(unique_report_rows, key=lambda x: x['Severity'])
